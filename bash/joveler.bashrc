# joveler.bashrc: Minimal bashrc for low-performance environment
#   Adapted from Linux Mint 20 default bashrc
#   
# Modifications:
#   - Display git branch information on bash prompt
#
...
function __joveler_parse_git_branch__()
{
...
if [ "$color_prompt" = yes ]; then
	...
	PS1="$PS1"'\w'           					    # pwd
	PS1="$PS1"' $(__joveler_parse_git_branch__)'    # git branch
	PS1="$PS1"'\n$ '                                # terminator
fi
# =============================================================================
